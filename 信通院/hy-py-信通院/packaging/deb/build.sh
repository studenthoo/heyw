...
MODULE_VERSION=$(python -c "execfile('${SRC_DIR}/hyperai/version.py'); print __version__")
...
rm -rf "$TARBALL_DIR"
mkdir -p "$TARBALL_DIR"
git archive --prefix "hyperai/" -o "${TARBALL_DIR}/hyperai.orig.tar.gz" HEAD
...
cd "$LOCAL_DIR"
DOCKER_BUILD_ID="hyperai-debuild"
