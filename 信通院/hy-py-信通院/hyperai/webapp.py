...
app.register_blueprint(hyperai.views.blueprint,
                       url_prefix=url_prefix)
import hyperai.dataset.views  # noqa

app.register_blueprint(hyperai.dataset.views.blueprint,
                       url_prefix=url_prefix + '/datasets')
import hyperai.dataset.generic.views  # noqa

app.register_blueprint(hyperai.dataset.generic.views.blueprint,
                       url_prefix=url_prefix + '/datasets/generic')
import hyperai.dataset.images.views  # noqa

app.register_blueprint(hyperai.dataset.images.views.blueprint,
                       url_prefix=url_prefix + '/datasets/images')
import hyperai.dataset.images.classification.views  # noqa

app.register_blueprint(hyperai.dataset.images.classification.views.blueprint,
                       url_prefix=url_prefix + '/datasets/images/classification')
import hyperai.dataset.images.generic.views  # noqa

app.register_blueprint(hyperai.dataset.images.generic.views.blueprint,
                       url_prefix=url_prefix + '/datasets/images/generic')
import hyperai.model.views  # noqa

app.register_blueprint(hyperai.model.views.blueprint,
                       url_prefix=url_prefix + '/models')
import hyperai.model.images.views  # noqa

app.register_blueprint(hyperai.model.images.views.blueprint,
                       url_prefix=url_prefix + '/models/images')
import hyperai.model.images.classification.views  # noqa

app.register_blueprint(hyperai.model.images.classification.views.blueprint,
                       url_prefix=url_prefix + '/models/images/classification')
import hyperai.model.images.generic.views  # noqa

app.register_blueprint(hyperai.model.images.generic.views.blueprint,
                       url_prefix=url_prefix + '/models/images/generic')
import hyperai.pretrained_model.views  # noqa

app.register_blueprint(hyperai.pretrained_model.views.blueprint,
                       url_prefix=url_prefix + '/pretrained_models')
import hyperai.store.views  # noqa

app.register_blueprint(hyperai.store.views.blueprint,
...
import hyperai.ration.views  # noqa

app.register_blueprint(hyperai.ration.views.blueprint,
                       url_prefix=url_prefix + '/ration')
