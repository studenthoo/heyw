...
@mock.patch('hyperai.tools.parse_folder.validate_output_file')
@mock.patch('hyperai.tools.parse_folder.validate_input_file')
...
<a href="birds/">birds/</a> 02-Feb-1999 12:34 -',
            ...
            with mock.patch('hyperai.tools.parse_folder.requests') as mock_requests:
                response = mock.Mock()
