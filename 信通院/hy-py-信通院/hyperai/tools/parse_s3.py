...
logger = logging.getLogger('hyperai.tools.parse_s3')
...
def validate_s3(walker, bucket, path):
    try:
        ...
        hyperai = walker.listbucket(bucket, prefix=path, with_prefix=True)
        for digit in hyperai:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Parse-S3 tool - hyperai')
