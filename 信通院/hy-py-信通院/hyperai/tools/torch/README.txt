...
th main.lua --train=/home/ubuntu/.hyperai/jobs/20150407-174547-f8f1/train_db --validation=/home/ubuntu/.hyperai/jobs/20150407-174547learningRateDecay-f8f1/val_db --network=lenet --networkDirectory=../../hyperai/standard-networks/torch/ --epoch=10 --save=/home/ubuntu/.hyperai/jobs/20150416-165008-4309 --snapshotPrefix=snapshot --snapshotInterval=1.000000 --subtractMean=yes --useMeanPixel=yes --mean=mean.jpg --labels=labels.txt --batchSize=32 --interval=1.000000 --learningRate=0.010000 --policy=step --gamma=0.100000 --stepvalues=33.000000

main.lua code uses data.lua module to load the images for training and validation, from lmdb.

--train=/home/ubuntu/.hyperai/jobs/20150407-174547-f8f1/train_db     => specifies train_db lmdb file contains all the images for training
--validation=/home/ubuntu/.hyperai/jobs/20150407-174547-f8f1/val_db  => specifies val_db lmdb file contains all the images for validation. This is an optional. Validations won't be done if not provided.
--network=lenet                                                     => specifies that the network file is "lenet.lua"
--networkDirectory=../../hyperai/standard-networks/torch/            => specifies that "lenet.lua" is present in "../../hyperai/standard-networks/torch/" directory
--epoch=10                                                          => specifies the total number of epochs
--save=/home/ubuntu/.hyperai/jobs/20150416-150654-37ca               => specifies the directory where weights file (named <SNAPSHOT_PREFIX>_<EPOCH_VALUE>_Weights.t7) and optimState (named optimState_<EPOCH_VALUE>.t7), are saved
...
th test.lua --image=/tmp/tmp4HHdV4.jpeg --network=lenet --networkDirectory=../../hyperai/standard-networks/torch/ --load=/home/ubuntu/.hyperai/jobs/20150416-150654-37ca --snapshotPrefix=snapshot --epoch=30 --subtractMean=yes --useMeanPixel=yes --mean=mean.jpg --labels=labels.txt

where,
--image=/tmp/tmp4HHdV4.jpeg                                         => specifies the image to be tested
--network=lenet                                                     => specifies that the network file is "lenet.lua"
--networkDirectory=../../hyperai/standard-networks/torch/            => specifies that "lenet.lua" is present in "../../hyperai/standard-networks/torch/" directory
--load=/home/ubuntu/.hyperai/jobs/20150416-150654-37ca               => specifies that trained network, named <SNAPSHOT_PREFIX>_<EPOCH_VALUE>_Weights.t7, exists in /home/ubuntu/.hyperai/jobs/20150416-150654-37ca
