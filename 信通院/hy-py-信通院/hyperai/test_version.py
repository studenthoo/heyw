...
class TestVersion():
    ...
    def test_package_version(self):
        import hyperai
        self.check_version(hyperai.__version__)

    def test_import_version(self):
        import hyperai.version
        self.check_version(hyperai.version.__version__)

    # Test a programmatic and reliable way to check the version
    # python -c "execfile('hyperai/version.py'); print __version__"
    def test_execfile_version(self):
        import hyperai
        filename = os.path.join(os.path.dirname(hyperai.__file__), 'version.py')
        file_locals = {}
    ...
    def test_package_version_matches_import_version(self):
        ...
        assert hyperai.__version__ == hyperai.version.__version__
