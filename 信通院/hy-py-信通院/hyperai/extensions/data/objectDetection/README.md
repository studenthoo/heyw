...
This data extension creates hyperai datasets for object detection networks such as [DetectNet](https://github.com/NVIDIA/caffe/tree/caffe-0.15/examples/kitti).

hyperai uses the KITTI format for object detection data.
...
When creating the dataset, hyperai has to translate from the object type string to a numerical identifier.
By default, hyperai uses the following class mappings, as follows from the above label format description:
