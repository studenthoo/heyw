...
class DataDownloader(object):
    """Base class for downloading data and setting it up for hyperai"""
    ...
    def getData(self):
        ...
        Downloads the dataset and prepares it for hyperai consumption
        """
    ...
    def processData(self):
        """
        Process the downloaded files and prepare the data for hyperai
        """
        raise NotImplementedError
