...
elif 'HYPERAI_YAML_DIR' in os.environ:
    value = os.environ['HYPERAI_YAML_DIR']
else:
    # value = os.path.join(os.path.dirname(hyperai.__file__), 'jobs')
    value = os.path.join('/home/nfsdir', 'public')

value = os.path.join(value,"yaml_dir")
...
try:
    ...
    print '"%s" is not a valid value for yaml_dir.' % value
    print 'Set the envvar HYPERAI_YAML_DIR to fix your configuration.'
    raise


option_list['yaml_dir'] = value
