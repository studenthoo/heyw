...
-----------------------------------------------------------------------------------------------------------------------------
--Note: At present hyperai supports only fine tuning, which means copying only the weights from pretrained model.
--
...
-- NOTE: currently randomState option wasn't used in hyperai. This option was provided to be used from command line, if required.
...
-- NOTE: currently retrain option wasn't used in hyperai. This option was provided to be used from command line, if required.
...
-- NOTE: currently lrpolicyState option wasn't used in hyperai. This option was provided to be used from command line, if required.
...
-- NOTE: currently optimState option wasn't used in hyperai. This option was provided to be used from command line, if required.
...
-- epoch value will be calculated for every batch size. To maintain unique epoch value between batches, it needs to be rounded to the required number of significant hyperai.
local epoch_round = 0 -- holds the required number of significant hyperai for round function.
local tmp_batchsize = trainBatchSize
while tmp_batchsize <= trainSize do
    tmp_batchsize = tmp_batchsize * 10
    epoch_round = epoch_round + 1
end
logmessage.display(0,'While logging, epoch value will be rounded to ' .. epoch_round .. ' significant hyperai')
...
-- NOTE: currently this routine wasn't used in hyperai.
