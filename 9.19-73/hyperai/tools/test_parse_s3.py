...
try:
    ...
    from hyperai.tools.mock_s3_walker import MockS3Walker
    import_failed = False
except ImportError:
    import_failed = True
...
@mock.patch('hyperai.tools.parse_s3.validate_output_file')
@mock.patch('hyperai.tools.parse_s3.validate_input_file')
...
<a href="birds/">birds/</a> 02-Feb-1999 12:34 -',
            ...
            with mock.patch('hyperai.tools.parse_s3.requests') as mock_requests:
                response = mock.Mock()
