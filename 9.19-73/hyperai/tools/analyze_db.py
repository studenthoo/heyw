...
from hyperai import log  # noqa

# Import hyperai.config first to set path to Caffe
import caffe.io  # noqa
import caffe_pb2  # noqa

logger = logging.getLogger('hyperai.tools.analyze_db')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Analyze-Db tool - hyperai')
