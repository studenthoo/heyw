...
if hyperai.config.config_value('tensorflow')['enabled']:
    import tensorflow as tf
else:
    tf = None

logger = logging.getLogger('hyperai.tools.create_db')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Create-Db tool - hyperai')
