...
class TrainTask(Task):
    ...
    def __init__(self, **kwargs):
        ...
        self.framework_name = kwargs['framework_name']
        self.framework_tag = kwargs['framework_tag']
        # self.image = config_value('img_mysql_ip') + ':'+ config_value('img_vip_port')+ "/hyperai/" + self.framework + "_" + self.framework_version + ":latest"
        self.image = config_value('img_mysql_ip') + ':'+ config_value('img_vip_port')+ "/" + self.framework_name + "_" +self.framework_tag +":latest"
        print self.image
